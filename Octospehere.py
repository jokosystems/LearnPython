...
def mystical_octosphere(question):
    ...
    if answer_fortune == "Yes, for sure!":
        print("The mystical octosphere says... " + colored(answer_fortune, "green", attrs = ["bold"]))
    else:
        print("The mystical octosphere says... " + colored(answer_fortune, "red", attrs=["bold"]))
